...
import spaceshapes.forms.util.FormElement;
...
public class TestImageShapeFormHandler {
	...
	public void setUpHandler() {
		// To create an ImageShapeFormHandler, a ShapeModel and a CarrierShape
		// are required.
		ShapeModel model = new ShapeModel(new Dimension(500,500));
		CarrierShape nest = new CarrierShape(0, 0, 1, 1, 100, 100);
		
		_handler = new DynamicRectangleShapeFormHandler(model, nest);
	}
